...
3. Declare (and define if you want) your "driver" function to match this template:
	...
	The return type is a struct defined in the file, and the 2 arguments are, in order, the status
	you told it to report (0 on startup) and the number of the button clicked (top=1).
